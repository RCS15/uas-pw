...
@section('content')
    <div class="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4 print:hidden">
        ...
        <button onclick="window.print()"
            class="inline-flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 hover:border-emerald-500 text-gray-700 hover:text-emerald-700 rounded-xl text-sm font-semibold shadow-sm transition-all duration-150">
    ...
    <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm shadow-gray-200/20 mb-8 flex flex-wrap gap-4 items-center justify-between print:hidden">
        <div class="flex items-center gap-3">
            <div>
                ...
                <select class="text-xs bg-gray-50 border border-gray-200 rounded-xl py-2.5 px-8 focus:outline-none focus:border-emerald-500 w-40 font-semibold">
    ...
    <div class="bg-white rounded-3xl border border-gray-100 shadow-xl shadow-gray-200/25 p-6 sm:p-10 max-w-4xl mx-auto print:border-0 print:shadow-none print:p-0">
        ...
        <div class="space-y-8 text-sm">
            {{-- Saldo Awal --}}
            <div class="flex justify-between items-center text-base font-extrabold text-gray-800 bg-gray-50 p-4 rounded-xl border border-gray-100/50 print:bg-white print:border-gray-200 mb-6">
            ...
            <div class="pt-4 border-t border-gray-200">
                <div class="flex justify-between items-center font-bold {{ $kenaikanPenurunanKas >= 0 ? 'text-gray-800' : 'text-rose-800' }}">
                    ...
                    <span class="{{ $kenaikanPenurunanKas >= 0 ? 'text-emerald-600' : 'text-rose-600' }}">
                        {{ $kenaikanPenurunanKas < 0 ? '-' : '' }} Rp {{ number_format(abs($kenaikanPenurunanKas), 0, ',', '.') }}
                    </span>
                </div>
            </div>
